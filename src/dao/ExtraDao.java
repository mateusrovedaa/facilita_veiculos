...
public class ExtraDao implements IDAO_T<Extra> {
    ...
    public String salvarExtra(Extra extra) {
        try {
    ...
    public String atualizar(Extra o) {
        try {
            ...
            System.out.println("Erro atualizar extra = " + e);
            return e.toString();
        }
    }
    ...
    public String excluir(int id) {
        try {
            ...
            System.out.println("Erro excluir extra = " + e);
            return e.toString();
        }
    }
    ...
    public void popularTabela(JTable tabela, String criterio) {
        ...
        try {
            resultadoQ = ConexaoBD.getInstance().getConnection().createStatement().executeQuery(""
                    + "SELECT count(*) FROM extras WHERE NOME ILIKE '%" + criterio + "%'");
...
//        });
    ...
    public void listarExtra(JTable tabela, String criterio) {
        // dados da tabela
        Object[][] dadosTabela = null;
