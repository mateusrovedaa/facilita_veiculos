...
public class VendaVeiculoDao implements IDAO_T<VendaVeiculo> {
    
    ResultSet resultadoQ = null;
    String now = LocalDateTime.now().format(DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss"));
    
    @Override
    public String salvar(VendaVeiculo o) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    
    @Override
    public String atualizar(VendaVeiculo o) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    
    @Override
    public String excluir(int vendaId) {
        try {
            ...
            System.out.println("Erro excluir parcelas = " + e);
            return e.toString();
        }
    }
    
    @Override
    public ArrayList<VendaVeiculo> consultarTodos() {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    
    @Override
    public ArrayList<VendaVeiculo> consultar(String criterio) {
        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
    
    @Override
    public VendaVeiculo consultarId(int id) {
        VendaVeiculo venda_veiculo = null;
        ...
        try {
            ...
            while (resultadoQ.next()) {
                venda_veiculo = new VendaVeiculo();
                
                venda_veiculo.setId(id);
                venda_veiculo.setVendaId(resultadoQ.getInt("venda_id"));
                venda_veiculo.setDataVencimento(resultadoQ.getString("data_vencimento"));
                venda_veiculo.setValorParcela(resultadoQ.getDouble("valor_parcela"));
                venda_veiculo.setStatus(resultadoQ.getBoolean("status"));
            }
            
        } catch (Exception e) {
            System.out.println("Erro consultar parcela = " + e);
        }
        
        return venda_veiculo;
    }
    
    public String gerarParcelas(int parcelas, double valor, String vendaId) {
