...
public class Combustivel implements Serializable {
    ...
    @Id
    @SequenceGenerator(name = "COMBUSTIVEL_SEQ", sequenceName = "seq_combustiveis", allocationSize = 1, initialValue = 1)
    @GeneratedValue(generator = "COMBUSTIVEL_SEQ", strategy = GenerationType.SEQUENCE)
    ...
    public Combustivel(Combustivel combustivel) {
        ...
        this.slug = combustivel.slug;
        this.criadoEm = combustivel.criadoEm;
        this.alteradoEm = combustivel.alteradoEm;
    }
