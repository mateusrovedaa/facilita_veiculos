...
public class RelatorioVendaUsuario extends javax.swing.JInternalFrame {

    public RelatorioVendaUsuario() {
        initComponents();
        campoDataDe.requestFocus();
        Formatacao.formatarData(campoDataDe);
        Formatacao.formatarData(campoDataAte);
        new ComboDao().popularCombo("usuarios", 1, 3, comboUsuarioId, "");
    }
    ...
    private void initComponents() {
        ...
        comboUsuarioId = new javax.swing.JComboBox<>();

        jTextField1.setText("jTextField1");

        setTitle("Relatório de vendas por usuário");
        ...
        comboUsuarioId.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(comboUsuarioId, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                .addContainerGap())
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(comboUsuarioId, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void btnGerarRelatorioCompraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGerarRelatorioCompraActionPerformed
        ...
        try {
            // Compila o relatorio
            JasperReport relatorio = JasperCompileManager.compileReport(getClass().getResourceAsStream("/relatorios/vendasUsuarios.jrxml"));

            // Mapeia campos de parametros para o relatorio, mesmo que nao existam
            Map parametros = new HashMap();

            ComboItem usuarioId = (ComboItem) comboUsuarioId.getSelectedItem();
            ...
            parametros.put("usuarioId", usuarioId.getCodigo());
    ...
    private javax.swing.JComboBox<String> comboUsuarioId;
