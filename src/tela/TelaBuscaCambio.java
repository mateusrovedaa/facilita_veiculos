...
public class TelaBuscaCambio extends javax.swing.JDialog {

    TelaCadastroVeiculo telaVeiculo;

    public TelaBuscaCambio(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }

    public TelaBuscaCambio(java.awt.Frame parent, boolean modal, TelaCadastroVeiculo telaVeiculo) {
        super(parent, modal);
        initComponents();
        this.telaVeiculo = telaVeiculo;
        new CambioDao().popularTabela(tblCambio, null);
    }
    ...
    private void initComponents() {
        ...
        btnDefinirCambio = new javax.swing.JButton();
        ...
        jLabel3.setText("Selecione o câmbio desejado");
        ...
        btnDefinirCambio.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/finalizar.png"))); // NOI18N
        btnDefinirCambio.setText("Definir câmbio");
        btnDefinirCambio.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnDefinirCambioActionPerformed(evt);
            }
        });
    ...
    private void btnDefinirCambioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDefinirCambioActionPerformed
        if (tblCambio.getSelectedRow() != -1) {
            String nomeCambio = String.valueOf(tblCambio.getValueAt(tblCambio.getSelectedRow(), 1));
            String codigoCambio = String.valueOf(tblCambio.getValueAt(tblCambio.getSelectedRow(), 0));
            telaVeiculo.definirCambio(Integer.parseInt(codigoCambio), nomeCambio);
            this.dispose();
        } else {
            JOptionPane.showMessageDialog(null, "Selecione um câmbio!");
        }
    }//GEN-LAST:event_btnDefinirCambioActionPerformed
    ...
    private void btnFiltrarCambioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFiltrarCambioActionPerformed
        if (campoFiltroCambio.getText().equals("")) {
            new CambioDao().popularTabela(tblCambio, null);
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaBuscaCambio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TelaBuscaCambio dialog = new TelaBuscaCambio(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JButton btnDefinirCambio;
